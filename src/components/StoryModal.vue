            ...
            >
                ...
                <div class="img-wrapper">
                    <img
                        ...
                        :src="state.storyModalContent.desktopImage"
                        alt="image"
                    />
                    <img
                        class="lg:hidden w-full"
                        :src="state.storyModalContent.mobileImage"
                        alt="image"
                    />
                </div>
            </div>
        ...
        'state.storyModal'(value) {
            ...
            if (value) {
                ...
                this.$router.push({
                    ...
                    query: { ...this.$route.query, story: true },
                ...
                if (this.$route.query.story) {
                    this.$router.replace({ story: null });
