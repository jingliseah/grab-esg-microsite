<template>
    <div
        class="thumbnail full fakePin section-14 bg-cover bg-center bg-no-repeat bg-[url('/images/pillar-1/section-1/social-background-img-mobile.jpg')] lg:bg-[url('/images/pillar-1/section-1/social-background-img-desktop.jpg')]"
    >
        <div
    ...
    methods: {
        triggerAnimation(thumbNails, offset) {
            let container = document.querySelector(
                '#pillar-one .section-14 .section-container'
            );

            let content = document.querySelector(
                '#pillar-one .section-14 .content'
            );

            let selectedTopic = document.querySelector(
                '#pillar-one .section-14 .selected-topic'
            );
