<template>
    <div class="thumbnail full section-4">
        <div class="relative h-screen lg:h-full">
            <div class="img-wrapper w-screen h-screen relative overflow-hidden">
                <div
                    class="img-background h-[120vh] w-full bg-no-repeat bg-center bg-cover bg-[url('/images/pillar-1/section-4/intro-background-img-mobile.jpg')] lg:bg-[url('/images/pillar-1/section-4/intro-background-img-desktop.jpg')]"
                ></div>
            </div>
            <div
                class="absolute h-full w-full text-left p-8 pb-28 lg:py-32 lg:pl-64 lg:pr-32 flex flex-col justify-end items-end z-50 top-0 left-0"
            >
                <div class="bg-blue/90 title-description-container">
                    <div class="overflow-hidden py-6 lg:py-9 px-8 lg:px-10">
                        ...
                        >
                            total earnings of our driver- and
                            merchant-partners<sup>1</sup>, <br class="hidden lg:block" />
                            <strong>
                                an increase of 24%
                                year-on-year</strong
                            >
    ...
    methods: {
        triggerAnimation(thumbNails, offset) {
            let titleDescriptionContainer = document.querySelector(
                '#pillar-one .section-4 .title-description-container'
            );

            let titleDescription = document.querySelectorAll(
                '#pillar-one .section-4 .title-description'
            );
            ...
            let timeline = gsap.timeline({
                scrollTrigger: {
                    ...
                    start: store.state.mobileView
                        ? 'top 80%'
                        : offset[index] - window.innerWidth * 0.65,
                    end: !store.state.mobileView && offset[index],
                    trigger: '#pillar-one .section-4',
